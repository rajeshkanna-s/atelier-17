...
const work = ['No. 04 / Hand-wound', 'Limon / Parfum', 'The Smallest Hinge'];
...
function App() {
  ...
  return (
    <main>
      ...
      <section id="top" className="hero-fullscreen">
        ...
        <div className="hero-content">
          ...
          <p className="hero-dek">
            A tactile, editorial portfolio for a studio shaping timepieces, fragrance,
            and the space between. Captured in high frame-rate motion.
          </p>
      ...
      <footer>
        <div className="footer-title">ATELIER 17</div>
        <div>
